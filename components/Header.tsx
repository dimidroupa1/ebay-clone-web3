    ...
    <div className="max-w-6xl mx-auto p-2">
      <nav className="flex justify-between">
        <div className="flex items-center space-x-4 text-sm">
          ...
          <p className="headerLink">Hope & Contact</p>
        </div>
      ...
      <section className="flex items-center space-x-2 py-5">
        ...
        <button className="hidden sm:inline bg-blue-600 text-white px-5 md:px-10 py-2 border-blue-600 border-2">
          Search
        </button>
      ...
      <section className="flex py-3 space-x-6 text-xs md:text-sm whitespace-nowrap justify-center px-6">
        ...
        <p className="link hidden lg:inline">Misic</p>
